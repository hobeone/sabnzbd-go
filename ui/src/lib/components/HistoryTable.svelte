		...
		>
			<div class="mb-4">
				...
				<Dialog.Description class="mt-2 text-sm text-gray-500">
					Are you sure you want to delete <span class="inline-block max-w-[200px] sm:max-w-xs align-bottom font-semibold text-gray-900 truncate" title={deleteTarget?.name}
