	...
	<td class="px-4 py-3">
		<div class="flex gap-1">
			<Button variant="ghost" size="icon-xs" onclick={togglePause} disabled={acting} title={isPaused() ? 'Resume' : 'Pause'}>
				...
				{:else}
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-3.5">
						<path d="M4.5 2a.75.75 0 0 0-.75.75v10.5c0 .414.336.75.75.75h1a.75.75 0 0 0 .75-.75V2.75A.75.75 0 0 0 5.5 2h-1ZM10.5 2a.75.75 0 0 0-.75.75v10.5c0 .414.336.75.75.75h1a.75.75 0 0 0 .75-.75V2.75a.75.75 0 0 0-.75-.75h-1Z" />
					</svg>
				{/if}
			</Button>
